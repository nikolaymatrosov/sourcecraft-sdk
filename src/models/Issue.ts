...
export function IssueFromJSONTyped(json: any, ignoreDiscriminator: boolean): Issue {
    ...
    return {
        ...
        labels:
            json["labels"] == null
                ? undefined
                : (json["labels"] as Array<any>).map(LabelEmbeddedFromJSON),
        linkedPrs:
            json["linked_prs"] == null
                ? undefined
                : (json["linked_prs"] as Array<any>).map(PullRequestEmbeddedFromJSON),
        milestone:
            json["milestone"] == null ? undefined : MilestoneEmbeddedFromJSON(json["milestone"]),
...
export function IssueToJSONTyped(value?: Issue | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        labels:
            value["labels"] == null
                ? undefined
                : (value["labels"] as Array<any>).map(LabelEmbeddedToJSON),
        linked_prs:
            value["linkedPrs"] == null
                ? undefined
                : (value["linkedPrs"] as Array<any>).map(PullRequestEmbeddedToJSON),
