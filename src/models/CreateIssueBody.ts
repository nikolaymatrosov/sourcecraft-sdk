...
export function CreateIssueBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateIssueBody {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateIssueBodyToJSONTyped(value?: CreateIssueBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
