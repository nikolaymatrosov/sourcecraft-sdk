...
|------------- | ------------- | -------------|
| [**addRepoRoles**](RepositoryRolesApi.md#addreporoles) | **POST** /repos/{org_slug}/{repo_slug}/roles | Add Repository Roles |
| [**addRepoRolesByID**](RepositoryRolesApi.md#addreporolesbyid) | **POST** /repos/id:{repo_id}/roles | Add Repository Roles (By ID) |
| [**listRepoRoles**](RepositoryRolesApi.md#listreporoles) | **GET** /repos/{org_slug}/{repo_slug}/roles | List Repository Roles |
| [**listRepoRolesByID**](RepositoryRolesApi.md#listreporolesbyid) | **GET** /repos/id:{repo_id}/roles | List Repository Roles (By ID) |
| [**removeRepoRoles**](RepositoryRolesApi.md#removereporoles) | **POST** /repos/{org_slug}/{repo_slug}/roles/remove | Remove Repository Roles |
| [**removeRepoRolesByID**](RepositoryRolesApi.md#removereporolesbyid) | **POST** /repos/id:{repo_id}/roles/remove | Remove Repository Roles (By ID) |



## addRepoRoles

> AddRepoRolesResponse addRepoRoles(orgSlug, repoSlug, addRepoRolesBody)
...
async function example() {
  ...
  const api = new RepositoryRolesApi(config);
...
[**AddRepoRolesResponse**](AddRepoRolesResponse.md)
...
> AddRepoRolesResponse addRepoRolesByID(repoId, addRepoRolesBody)
...
> ListRepoRolesResponse listRepoRoles(orgSlug, repoSlug, pageSize, pageToken, sortBy)
...
[**ListRepoRolesResponse**](ListRepoRolesResponse.md)
...
> ListRepoRolesResponse listRepoRolesByID(repoId, pageSize, pageToken, sortBy)
...
> RemoveRepoRolesResponse removeRepoRoles(orgSlug, repoSlug, removeRepoRolesBody)
...
[**RemoveRepoRolesResponse**](RemoveRepoRolesResponse.md)
...
> RemoveRepoRolesResponse removeRepoRolesByID(repoId, removeRepoRolesBody)
